...
python3.12 tools/kn_estimator/estimate.py legacy-sut --mode template --model sonnet
# → N=167 chunks=60 k_avg=2.8 est=$143.9, legacy-sut/.kn/{kn-report.md,kn-plan.json}
```
