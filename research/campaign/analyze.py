...
def comparison_table(cals):
    ...
    for cell in all_cells:
        for src_name, cal in [("smartplant(동봉)", BUNDLED)] + sorted(cals.items()):
...
def main():
    ...
    print("== ① 셀 계수 비교 (SmartPlant 동봉 vs 캠페인 프로젝트) ==\n")
